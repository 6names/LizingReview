...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(499)(module)))
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__docElement__ = __webpack_require__(132);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__childNode_remove__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__docElement__ = __webpack_require__(132);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isNodeList__ = __webpack_require__(134);
...
(function (root, factory)
{
    ...
    if (true) {
        ...
        try { moment = __webpack_require__(1); } catch (e) {}
...
var _mobileNav = __webpack_require__(466);

var _modals = __webpack_require__(467);

var _accordions = __webpack_require__(468);

var _formElemnts = __webpack_require__(469);

var _validation = __webpack_require__(470);

var _tinySliderModule = __webpack_require__(471);
...
function initFunc() {
    ...
    _formElemnts.Forms.checkbox(modalHolder);
    _formElemnts.Forms.radio(modalHolder);
    _formElemnts.Forms.file(document.body);
    _formElemnts.Forms.customSelects(modalHolder, 'select');

    // Forms validation
    (0, _validation.validate)('modal-subscribe-form', function (e) {
        _modals.Modal.testModal('confirm-modal');
        e.preventDefault();
    });
    (0, _validation.validate)('modal-vacancy-form', function (e) {
        _modals.Modal.testModal('confirm-modal');
        e.preventDefault();
    });
    (0, _validation.validate)('modal-request-form', function (e) {
        _modals.Modal.testModal('confirm-modal');
        e.preventDefault();
    });

    // Datepicker
    var vacancyDate = document.getElementById('vacancy-form-date');
    if (vacancyDate) {
        new Promise(function(resolve) { resolve(); }).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__(137)]; ((function (Pikaday) {
    ...
    // Gallery
    var gallerySlider = document.querySelectorAll('.modal__gallery-slider');
    Array.from(gallerySlider).forEach(function (slider) {
...
// Form elements
_formElemnts.Forms.checkbox(document.body);
_formElemnts.Forms.radio(document.body);
_formElemnts.Forms.file(document.body);
_formElemnts.Forms.customSelects(document.body, 'select');

// Form validations
(0, _validation.validate)('subscribe-form');

(0, _validation.validate)('event-registration', function (e) {
    formsConfirm(e, '.sidebar-form__title', '.sidebar-form__content');
    e.preventDefault();
});

(0, _validation.validate)('advertising-request', function (e) {
    formsConfirm(e, '.sidebar-form__title', '.sidebar-form__content');
    e.preventDefault();
});
...
// Accordions
_accordions.Drop.dropDown(document.body, '.vacancy__item-title', '.vacancy__item-content');
_accordions.Drop.dropDown(document.body, '.advertising__item-title', '.advertising__item-content');
_accordions.Drop.dropDown(document.body, '.selling__item-title', '.selling__item-content');
_accordions.Drop.dropDown(document.body, '.accordion__title', '.accordion__content');

// Sliders
var magazineSlider = document.querySelectorAll('.magazine-preview__slider');
Array.from(magazineSlider).forEach(function (slider) {
    (0, _tinySliderModule.tns)({
        container: slider,
        slideBy: 'page',
        autoplay: false,
...
Array.from(eventSlider).forEach(function (slider) {
    (0, _tinySliderModule.tns)({
        container: slider,
        slideBy: 'page',
        autoplay: false,
...
if (anchors) {
    anchorsArr.forEach(function (anchor) {
...
if (!(TO_PRIMITIVE in proto)) __webpack_require__(12)(proto, TO_PRIMITIVE, __webpack_require__(346));
...
var $export = __webpack_require__(0);
var $re = __webpack_require__(463)(/[\\^$*+?.()|[\]{}]/g, '\\$&');
            ...
            for (; s < this.matchGroups.length; s++) {
                ...
                for (; i < a.length; i++) {
                    ...
                    if (e = a[i] || 'string' === typeof e.uaString) {
                        ...
                        for (var t = 0, _r = !0; t < e.uaString.length; t++) {
                            if (!this.uaMatch(e.uaString[t])) {
                                _r = !1;
                                break;
                            }
                        }if (r) {
...
var Modal = exports.Modal = function () {
    ...
    _createClass(Modal, null, [{
        ...
        value: function getModal(callBack) {
            ...
            Array.from(modalTriggers).forEach(function (trigger) {
...
var Drop = exports.Drop = function () {
    ...
    _createClass(Drop, null, [{
        ...
        // Tabs
        value: function tabs(parent, triggers, contents) {
            var triggerList = parent.querySelectorAll(triggers);
            var triggersArr = Array.from(triggerList);
            var contentList = parent.querySelectorAll(contents);
            var contentArr = Array.from(contentList);

            triggersArr.forEach(function (trigger) {
                trigger.addEventListener('click', function () {
                    var i = triggersArr.indexOf(trigger);
                    ...
                    try {
                        for (var _iterator = document.querySelectorAll(triggers)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                            var t = _step.value;
                    ...
                    try {
                        for (var _iterator2 = document.querySelectorAll(contents)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                            var c = _step2.value;
        ...
        key: 'accordion',
        value: function accordion(parent, triggers, content) {
            Array.from(parent.querySelectorAll(triggers)).forEach(function (trigger) {
                trigger.addEventListener('click', function () {
                    if (trigger.classList.contains('active')) {
                        ...
                        try {
                            for (var _iterator3 = document.querySelectorAll(triggers)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
                        ...
                        try {
                            for (var _iterator4 = document.querySelectorAll(content)[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        ...
        key: 'dropDown',
        value: function dropDown(parent, triggers, content) {
            Array.from(parent.querySelectorAll(triggers)).forEach(function (trigger) {
                trigger.addEventListener('click', function () {
                    Array.from(trigger.querySelectorAll('span')).forEach(function (text) {
...
var Forms = exports.Forms = function () {
    ...
    _createClass(Forms, null, [{
        ...
        // Amount input
        value: function amountInput(parent, min, max) {
            var amountInputs = parent.querySelectorAll('input.amount-input');

            Array.from(amountInputs).forEach(function (amount) {
                ...
                var amountUp = document.createElement('button');
                amountUp.className = 'amount-up';
                amountUp.innerHTML = '+';
                wrapper.append(amountUp);

                var amountDown = document.createElement('button');
                ...
                amountUp.addEventListener('click', function () {
                    if (amount.value === max) {
                        amount.value = max;
                    } else {
                ...
                amountDown.addEventListener('click', function () {
                    if (amount.value === min) {
                        amount.value = min;
                    } else {
                        amount.value = (--amount.value).toString();
            ...
            Array.from(radioBtns).forEach(function (radio) {
                ...
                function radioChange() {
                    if (radio.checked) {
                        ...
                        try {
                            for (var _iterator = document.querySelectorAll('.' + groupName)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        key: 'checkbox',
        value: function checkbox(parent) {
            var checkBtns = parent.querySelectorAll('input.check');

            Array.from(checkBtns).forEach(function (check) {
        ...
        key: 'customSelects',
        value: function customSelects(parent, target, cb) {
            ...
            if (selects) {
                Array.from(selects).forEach(function (select) {
                    ...
                    Array.from(options).forEach(function (option, i) {
                        ...
                        function currentOption() {
                            ...
                            try {
                                for (var _iterator2 = select.parentNode.querySelectorAll('.select__option')[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                        ...
                        optionWrapper.addEventListener('touchend', function () {
                            return currentOption();
                        });
                    });
                    ...
                    function closeAll() {
                        Array.from(document.querySelectorAll('.select__list')).forEach(function (list) {
                            list.classList.remove('select__list-active');
                        });
                        Array.from(document.querySelectorAll('.select__value')).forEach(function (value) {
...
function validate(formEl, callback) {
    ...
    if (form) {
        ...
        var textareasArr = Array.from(textareas);
        var selectsArr = Array.from(selects);
        ...
        // Selects
        selectsArr.forEach(function (select) {
            error = select.dataset.errorMessage;
            var options = select.parentElement.querySelectorAll('.select__option');
        ...
        // Textarea
        textareasArr.forEach(function (textarea) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__helpers_keys__ = __webpack_require__(472);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__helpers_childNode_remove__ = __webpack_require__(50);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__helpers_extend__ = __webpack_require__(473);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helpers_checkStorageValue__ = __webpack_require__(474);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__helpers_setLocalStorage__ = __webpack_require__(475);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__helpers_getSlideId__ = __webpack_require__(476);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__helpers_calc__ = __webpack_require__(477);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__helpers_subpixelLayout__ = __webpack_require__(478);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__helpers_mediaquerySupport__ = __webpack_require__(479);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__helpers_createStyleSheet__ = __webpack_require__(480);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__helpers_addCSSRule__ = __webpack_require__(481);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__helpers_getCssRulesLength__ = __webpack_require__(482);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__helpers_toDegree__ = __webpack_require__(483);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__helpers_getTouchDirection__ = __webpack_require__(484);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__helpers_hasClass__ = __webpack_require__(95);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__helpers_addClass__ = __webpack_require__(485);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__helpers_removeClass__ = __webpack_require__(486);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__helpers_hasAttr__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__helpers_getAttr__ = __webpack_require__(487);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__helpers_setAttrs__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__helpers_removeAttrs__ = __webpack_require__(135);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__helpers_removeElementStyles__ = __webpack_require__(488);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__helpers_hideElement__ = __webpack_require__(489);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__helpers_showElement__ = __webpack_require__(490);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__helpers_isVisible__ = __webpack_require__(491);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__helpers_imageLoaded__ = __webpack_require__(492);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__helpers_whichProperty__ = __webpack_require__(493);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__helpers_getEndProperty__ = __webpack_require__(494);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__helpers_addEvents__ = __webpack_require__(495);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__helpers_removeEvents__ = __webpack_require__(496);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__helpers_events__ = __webpack_require__(497);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__helpers_jsTransform__ = __webpack_require__(498);
// Format: ES MODULE
// Version: 2.6.0
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__childNode_remove__ = __webpack_require__(50);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__childNode_remove___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__childNode_remove__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__getBody__ = __webpack_require__(92);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__setFakeBody__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__resetFakeBody__ = __webpack_require__(94);
// get css-calc 
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hasClass__ = __webpack_require__(95);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hasAttr__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__setAttrs__ = __webpack_require__(133);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__hasAttr__ = __webpack_require__(96);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__removeAttrs__ = __webpack_require__(135);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__passiveOption__ = __webpack_require__(136);
